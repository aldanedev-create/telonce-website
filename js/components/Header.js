            ...
            <div class="container-custom">
                <div class="flex items-center justify-between h-16 md:h-20">
                    ...
                    <router-link to="/" class="flex items-center gap-2.5 group" @click="closeMobile">
                        <img src="/assets/images/telonce.png" alt="Teloce" class="h-8 w-auto" />
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <!-- GitHub Link -->
                        <a href="https://github.com/aldanedev-create/telonce" target="_blank" rel="noopener noreferrer" class="p-2 rounded-lg text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors" aria-label="GitHub">
