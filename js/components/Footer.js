            ...
            <div class="container-custom py-12 md:py-16">
                <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
                    ...
                    <div class="col-span-2 md:col-span-1">
                        <div class="flex items-center gap-2.5 mb-4">
                            <img src="/assets/images/telonce.png" alt="Teloce" class="h-7 w-auto" />
                        ...
                        <div class="flex items-center gap-3 mt-4">
                            <a href="https://github.com/aldanedev-create/telonce" target="_blank" rel="noopener" class="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors">
                            ...
                            <a href="https://youtube.com/@flaxonandtelonce?si=QFk0BEe7KYwZDnBW" target="_blank" rel="noopener" class="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div>
                        ...
                        <ul class="space-y-2.5 text-sm">
                            ...
                            <li><a href="https://github.com/aldanedev-create/telonce/releases" target="_blank" rel="noopener" class="text-gray-500 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">Releases</a></li>
                            <li><a href="https://github.com/aldanedev-create/telonce/blob/main/CHANGELOG.md" target="_blank" rel="noopener" class="text-gray-500 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">Changelog</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul class="space-y-2.5 text-sm">
                            ...
                            <li><a href="https://github.com/aldanedev-create/telonce" target="_blank" rel="noopener" class="text-gray-500 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">GitHub</a></li>
                    ...
                    <div>
                        ...
                        <ul class="space-y-2.5 text-sm">
                            ...
                            <li><a href="https://github.com/aldanedev-create/telonce/main/LICENSE" target="_blank" rel="noopener" class="text-gray-500 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">License (MIT)</a></li>
                            <li><a href="https://github.com/aldanedev-create/telonce" target="_blank" rel="noopener" class="text-gray-500 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">⭐ Star on GitHub</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="border-t border-gray-200 dark:border-gray-800 mt-8 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
                    ...
                    <div class="flex items-center gap-6 text-sm text-gray-500 dark:text-gray-400">
                        <a href="https://github.com/aldanedev-create/telonce/blob/main/CODE_OF_CONDUCT.md" target="_blank" rel="noopener" class="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">Code of Conduct</a>
                        <span>|</span>
